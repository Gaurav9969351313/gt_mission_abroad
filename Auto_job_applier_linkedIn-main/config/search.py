...
search_terms = ["Spring Boot", "Java Full Stack", "Java Full Stack Engineer", "Java Developer", "Full Stack Developer"]
...
bad_words = ["Android","C++","Founding","CTO", "US Citizen","USA Citizen","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
